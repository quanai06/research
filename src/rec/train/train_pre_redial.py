...
from src.rec.data.redial_pretrain_dataset import CRSDataset, CRSDataCollator_mm
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='./pretrained/pre-trained-redial', help="Where to store the final model.")
    ...
    parser.add_argument("--cl_loss_weight", type=float, default=0.0)
