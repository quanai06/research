...
src_files = ['inspired/test.jsonl', 'inspired/dev.jsonl', 'inspired/train.jsonl']
tgt_files = ['inspired/test_data_dbpedia.jsonl', 'inspired/valid_data_dbpedia.jsonl', 'inspired/train_data_dbpedia.jsonl']
